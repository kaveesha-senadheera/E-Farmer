...
function CreateExpenses() {
  ...
  const validateForm = () => {
    ...
    } else if (/[@]/.test(name)) newErrors.name = 'Name must not contain @ symbol.';
  ...
  const handleSaveExpense = () => {
    ...
    axios
      ...
      .then((response) => {
        ...
        // Redirect to the ShowExpense page 
        const newExpenseId = response.data._id; 
        navigate(`/expenses/details/${newExpenseId}`); 
      })
      .catch((error) => {
        setLoading(false);
      ...
      <div style={styles.formContainer}>
        ...
        <div style={styles.inputGroup}>
          ...
          <input
            type='text'
            value={cost}
            onChange={(e) => {setCost(e.target.value); validateForm();}}
            style={styles.input}
          />
